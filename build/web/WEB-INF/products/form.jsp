                            ...
                            <div class="content-box-large">
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" role="form" action="products" method="post">
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-12">
                                                <input type="number" class="form-control" name="idProd"
                                                       ...
                                                       value="<% if(typeForm.equals("update")){ out.print(prod.getProductId());} %>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <select class="form-control" name="idProv">
                                                    ...
                                                    <option value="<%= prov.getProvider_id()%>" selected=" <% if (typeForm.equals("update") && prov.getProvider_id()== prod.getProvider().getProvider_id()) {
                                                        out.print("true");
                                                    }  %> "><%= prov.getName()%></option>
                                                    <% } %>
                                                </select>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-12">
                                                <input type="text" class="form-control" name="priceU" placeholder="Unitary price..." value="<% if(typeForm.equals("update")){ out.print(prod.getUnitPrice());} %>">
                                            </div>
                                        </div>
